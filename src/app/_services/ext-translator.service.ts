...
export class ExtTranslatorService {
  ...
  translateText(text: string, lng_src: string, lng_dest: string) : Observable<any> {
    return this.http.post(API_URL + '/', {text: text, lng_src: lng_src, lng_dest: lng_dest}, httpOptions);
  }
}
